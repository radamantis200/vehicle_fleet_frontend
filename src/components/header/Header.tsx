...
const Header = () => {
  const { isOpenSidebar, colorTheme, handleToggleSidebar, handleColorTheme } = useLayout()
  const openSidebar = isOpenSidebar ? '' : 'hidden'
  const openHambuerger = isOpenSidebar ? 'hidden' : ''
  return (
    <>
        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              <button onClick={handleToggleSidebar} id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar"
                className="p-2 text-gray-600 rounded cursor-pointer lg:hidden hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                <svg id="toggleSidebarMobileHamburger" className={`${openHambuerger} w-6 h-6`} fill="currentColor" viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd"
                    d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h6a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z"
                    clipRule="evenodd"></path>
                </svg>
                <svg id="toggleSidebarMobileClose" className={`${openSidebar} w-6 h-6`} fill="currentColor"
              ...
              <a href="#" className="flex ml-2 md:mr-24">
                <img src="https://flowbite-admin-dashboard.vercel.app/images/logo.svg" className="h-8 mr-3"
                  alt="FlowBite Logo" />
                <span
                  className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Vehicle</span>
              </a>
            ...
            <div className="flex items-center">
              ...
              <button onClick={handleToggleSidebar} id="toggleSidebarMobileSearch" type="button"
              ...
              <button onClick={handleColorTheme} id="theme-toggle" data-tooltip-target="tooltip-toggle" type="button"
                className="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
                {colorTheme === 'light' ? <svg id="theme-toggle-dark-icon" className={`w-5 h-5`} fill="currentColor" viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg">
      ...
      <div className={`fixed inset-0 z-10 bg-gray-900/50 dark:bg-gray-900/90 ${openSidebar}`} id="sidebarBackdrop"></div>
    </>
  )
}
