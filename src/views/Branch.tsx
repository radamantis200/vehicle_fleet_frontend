...
import useSucursal from "@/hooks/useBranch"
import { useEffect } from "react"
import { initFlowbite } from "flowbite"

const Sucursal = () => {
    const { branchQuery } = useSucursal()
    const { data: branch, isLoading, isFetching } = branchQuery
    useEffect(() => {
        initFlowbite()
    }, [branch])
            ...
            <div id="main-content" className="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
                <div
                    ...
                    <div className="w-full mb-1">
                        <div className="mb-4">
                            <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Sucursales</h1>
                        </div>
                        <div className="md:flex">
                            ...
                            <div className="flex items-center ml-auto space-x-2 sm:space-x-3">
                                <button data-modal-target="add-branch" data-modal-toggle="add-branch" className="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-blue-700 dark:focus:ring-primary-800" type="button">
                                        ...
                                        {isLoading || isFetching ? (<h2>Is Loading...</h2>) : (branch?.response && branch.response.map(branch =>
                                            <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <td className="p-4 space-x-2 whitespace-nowrap">
                                                    <button data-modal-target="update-branch" data-modal-toggle="update-branch" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-blue-700 dark:focus:ring-primary-800" type="button">
